...
public class HundredThousand {
	...
	public static int[] huntho() {
		int[] huntho = new int[100000];
		for (int i=0;i<huntho.length;i++) {
			Random randomGenerator = new Random();
			huntho[i] = randomGenerator.nextInt(10000000);
		}
		//Collections.shuffle(Arrays.asList(huntho));
		return huntho;
	}
	...
	public static void main(String[] args) {
		...
		Integer[] quickbase = new Integer[100000];
		...
		//Results
		System.out.println("Bubble sort time for 100,000: " + bubbleTime);
		System.out.println("Selection sort time for 100,000: " + selectionTime);
		System.out.println("Insertion sort time for 100,000: " + insertionTime);
		System.out.println("Merge sort time for 100,000: " + mergeTime);
		System.out.println("Heap sort time for 100,000: " + heapTime);
		System.out.println("Quick sort time for 100,000: " + quickTime);
